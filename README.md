...
* The iteration graph consists of two curves- Training AUC and Validation AUC. The graph shows that till the tree depth 6, the graph line of Training AUC and Validation AUC have less error which is feasible model. As the tree depth increases then the error is increasing and both the curves are having more deviation.

![variable importance](https://user-images.githubusercontent.com/111528985/186750828-b5d82249-9db2-405f-91ad-4e4f1e0f1540.png)

* The Variable importance is useful for finding the good decision model. At pay_0 which is most recent payment bill has highest importance compared to any other variable for the decision model. It signifies that the pay_0 has more importance. It is a bad sign of having more importance to only one variable i.e. tha model is too dependent on only pay_0 variable.

![iteration plot 2](https://user-images.githubusercontent.com/111528985/186750922-9d3b59c7-07d5-443d-a5cc-cd1ce32bcbb2.png)

* The image shows three graphical lines- Training AUC, Validation AUC and Hispanic-to-white AIR. 
     - Training AUC: The training auccracy increases as the decision tree depth gets more complex and due to memorization. 
     - Validation AUC: It's useful for finding the number of decision trees to be used for the decision model. 
     - Hispanic-to-White AIR: The data is picked since it is the lowest fairness measure therefore it's the most concerning measure. The Hispanic-to-white AIR is up above 0.8 at the tree depth of 6. The fairness measure is 0.8 for the decision tree. In terms of fairness and accuracy, the feasible decision tree model is at the tree depth of 6.
